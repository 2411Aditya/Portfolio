...
const About = () => {
  return (
    <section id="about" className="relative px-[1.5rem] md:px-[4rem] py-24 bg-[#141414]">
      <div className="max-w-[1600px] mx-auto w-full grid md:grid-cols-12 gap-12 items-start">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="md:col-span-5 bg-[#181818] border border-white/5 p-8 rounded-lg shadow-xl"
        >
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span key={i} className="px-3.5 py-1.5 bg-[#2f2f2f] text-white rounded-full text-xs font-semibold hover:bg-[#e50914] hover:text-white transition-colors duration-300 cursor-default">
                {area}
              </span>
            ))}
          </div>
