  ...
  return (
    <section id="contact" className="relative px-[1.5rem] md:px-[4rem] py-32 bg-[#141414] border-t border-white/5 flex flex-col justify-center items-center">
      <div className="max-w-[1600px] mx-auto w-full text-center flex flex-col items-center">
        ...
        >
          <span className="text-[#e50914] font-extrabold text-sm tracking-widest uppercase mb-4">What's Next?</span>
          ...
          <p className="text-base md:text-xl text-[#a3a3a3] max-w-2xl mb-12 leading-relaxed font-sans">
            I'm always open to discussing new opportunities, AI projects, or software engineering collaborations. Hit me up.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center w-full max-w-md items-center">
            <a 
              href="https://wa.me/917775815981"
              target="_blank"
